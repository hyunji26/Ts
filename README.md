# **tasteSom: 맛집 검색 및 추천 시스템**

### 👨‍🏫 **프로젝트 소개**
**tasteSom**은  주변 식당 정보를 제공하고 자주 검색된 메뉴를 추천해주는 웹 애플리케이션입니다. 유저들은 메뉴 검색, 리뷰 작성 및 별점 평가를 통해 식당 정보를 제공받을 수 있으며, 식당 주인은 자신의 메뉴와 식당 정보를 등록 및 관리할 수 있습니다.

### ⏲️ **개발 기간**
**2024.09.01 ~ 2024.12.20**

### 🧑‍🤝‍🧑 **개발자 소개**
- **임현지**: DB 설계, 회원 가입,로그인, 메뉴 검색, 메뉴 추천 기능 개발
...
- **리뷰 작성 및 별점 평가**: 유저는 식당에 대한 리뷰를 작성하고 별점을 남길 수 있으며, 이 정보는 다른 사용자에게 공유됩니다.
